...
COLUMN_MAP = {
    "recovery_score": ["Recovery Score", "Recovery", "recovery_score"],
    "hrv": ["HRV (ms)", "HRV", "hrv", "Heart Rate Variability"],
    "resting_hr": ["Resting HR", "Resting Heart Rate", "resting_hr", "RHR"],
    "sleep_hours": ["Sleep Hours", "Total Sleep", "sleep_hours", "Sleep Duration"],
    "sleep_quality": ["Sleep Quality", "Sleep Performance", "sleep_quality"],
    "strain": ["Strain", "Day Strain", "strain", "Daily Strain"],
    "active_calories": ["Calories", "Total Calories", "active_calories", "Kilojoules"],
}
...
DATE_COLUMNS = ["Date", "Cycle Start", "date", "Day"]
...
def parse_whoop_csv(file_path: str) -> list[dict]:
    results = []
